...
public class StepsView extends LinearLayout implements StepsViewIndicator.OnDrawListener {
    ...
    private int mLabelSelectColorIndicator = Color.BLACK;
    ...
    public StepsView(Context context, AttributeSet attrs,
        ...
        int progressColor = arr.getColor(R.styleable.StepsView_progressColor, ContextCompat.getColor(context, R.color.color_price));
        int labelColor = arr.getColor(R.styleable.StepsView_labelColor, Color.BLACK);
        int selectlabelColor = arr.getColor(R.styleable.StepsView_selectlabelColor, Color.BLACK);
        ...
        this.setLabelSelectColorIndicator(selectlabelColor);
        arr.recycle();
        // initial draw view
        drawView();
    }
    ...
    public StepsView setLabelSelectColorIndicator(int LabelSelectColorIndicator) {
        mLabelSelectColorIndicator = LabelSelectColorIndicator;
        return this;
    }
        ...
        if (mLabels != null) {
            for (int i = 0; i < mLabels.length; i++) {
                ...
                if (i <= mCompletedPosition) {
                    textView.setTextColor(mLabelSelectColorIndicator);
                } else {
    ...
    public void setcompletePosition(int CurrentcompletePos) {
        this.setCompletedPosition(CurrentcompletePos);
        drawView();
    }
}
